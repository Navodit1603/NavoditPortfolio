...
export default function About() {
    return (
        <div id="about">
            <div className="min-h-screen px-4 py-16 bg-[#101829] flex flex-col items-center">
                {/* Title */}
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center max-w-6xl w-full gap-12">
                    ...
                    <div className="flex flex-col items-center flex-shrink-0">
                        ...
                        />
                        <h3 className="text-[#F8FCFA] pt-4 text-lg font-semibold">Navodit Maheshwari</h3>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row justify-center gap-6 mt-12 w-full max-w-6xl">
                    ...
                    {/* Contact */}
                    <div className="flex flex-col items-center lg:items-start text-[#F8FCFA] w-full lg:w-1/4 px-4 text-center lg:text-left">
                        <div className="pb-4">
                    ...
                    <div className="w-full lg:w-3/4 px-4 flex flex-col items-start">
                        <h3 className="text-[#F8FCFA] text-3xl sm:text-3xl md:text-4xl font-bold mb-6">
                            Skills
                        </h3>
