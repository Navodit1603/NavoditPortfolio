...
export default function About() {
    return (
        <div>
            ...
            >
                <div className="min-h-screen px-4 py-12 bg-gray-900 flex flex-col items-center">
                    {/* Title */}
                    <h1 className="text-amber-600 text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12">
                        About Me
                    </h1>
